            ...
            const testLinks = {
                ...
                "Neurophysiologie": [
                    { name: "Pack  (Défi SVT): Tissu Nerveux", link: "#" },
                    { name: "Pack 1 (Défi SVT): Réflexe myotatique", link: "#" },
                    { name: "Pack 2 (Défi SVT): Réflexe myotatique", link: "#" },
                    { name: "Pack  (Défi SVT): Fonctionnement du muscle squelettique", link: "#" },
                    { name: "Pack  (Défi SVT): Régulation de la pression artérielle", link: "#" },
                    { name: "Pack  (Défi SVT): Hygiéne du système nerveux", link: "#" }
                ],
                "Immunite": [
